        ...
        <div className="flex flex-col gap-3 text-sm p-3 rounded-lg bg-gray-900/30 border border-gray-800/50 shadow-inner">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col gap-2 flex-1">
              ...
              <div className="h-3 bg-gray-800 rounded animate-pulse w-48"></div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="flex flex-col gap-3 text-sm p-3 rounded-lg bg-gray-900/30 border border-gray-800/50 shadow-inner">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col gap-1">
              ...
              <span className="text-white text-sm">No recent activity</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col gap-1 flex-1 min-w-0">
            ...
            <div className="flex flex-col min-h-[2.5rem] max-h-[2.5rem]" style={{ opacity: 1, transform: 'none' }}>
              ...
              <span className="text-xs text-gray-400 truncate h-4">by {artistNames}</span>
            </div>
          </div>
        </div>
