        ...
        <div className="w-full max-w-3xl mx-auto">
          <div className="flex flex-col items-start space-y-6">
            ...
            <div className="flex flex-wrap items-center gap-3 mt-6">
              <a href="/Ashish_Prajapati_Resume.pdf" target="_blank" rel="noopener noreferrer" className="px-4 py-2.5 bg-white dark:bg-[#0f0f0f] hover:bg-gray-50 dark:hover:bg-[#1a1a1a] border border-gray-200 dark:border-gray-800 hover:border-gray-300 dark:hover:border-gray-700 rounded-lg transition-colors flex items-center gap-2 text-gray-900 dark:text-white text-sm font-medium shadow-sm">
